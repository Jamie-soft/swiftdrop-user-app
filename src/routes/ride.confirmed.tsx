...
export const Route = createFileRoute("/ride/confirmed")({
  head: () => ({
    meta: [
      { title: "Ride Confirmed — SwiftDrop" },
      { name: "description", content: "Your ride request has been received." },
    ],
  }),
...
function RideConfirmedPage() {
  ...
  const last = orders.find((o) => o.kind === "ride");
    ...
    <AppShell>
      <div className="flex min-h-[70vh] flex-col items-center justify-center text-center">
        ...
        <p className="mt-3 max-w-xs text-sm text-muted-foreground">
          A driver will contact you within 20 minutes to confirm your ride.
        </p>
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-border bg-surface p-3 text-left">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm font-semibold flex items-center gap-2">
                  {riderLoading ? (
                    <><Loader2 className="h-3 w-3 animate-spin" /> Searching for driver…</>
                  ) : rider ? (
