...
import { signUp, useAuth } from "@/lib/authStore";

export const Route = createFileRoute("/auth/signup")({
  head: () => ({
    meta: [
      { title: "Sign Up — SwiftDrop" },
      { name: "description", content: "Create your SwiftDrop account." },
    ],
  }),
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Start moving smarter today</p>
        </div>
